...
def _process_single_match_task(
    ...
    """
    try:
        home_stats = statistics_service.convert_to_domain_stats(match.home_team.name, raw_home)
        away_stats = statistics_service.convert_to_domain_stats(match.away_team.name, raw_away)
